...
#define BOSS_FLYING_ATTACK_SIMON_SPEED		0.3f
#define BOSS_FLYING_RANDOM_SPOT_SPEED		0.2fit
...
#define WEAPON_BOOMERANG	4
#define WEAPON_AXE			5
#define WEAPON_STOP_WATCH	6
#define WEAPON_HOLY_WATER	7
#define WEAPON_HOLY_WATER_SHATTERED	8
